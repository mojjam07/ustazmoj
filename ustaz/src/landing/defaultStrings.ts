...
export const defaultStrings: LandingStrings = {
  nav: {
    subjects: 'Subjects',
  ...
  methodology: {
    ...
    steps: [
      {
        title: 'Preparation & Teaching',
        desc: 'A clear beginning: structured lessons for learners, with consistent progress.'
      },
      {
        title: 'Assessment & Planning',
        desc: 'A practical plan based on assessment, starting points, and learner needs.'
      },
      {
        title: 'Practice & Review',
        desc: 'Regular practice with gentle review to ensure lasting understanding.'
      },
      {
        title: 'Progress & Confirmation',
        desc: 'Ongoing checkpoints to confirm mastery and keep learners motivated.'
      }
    ]
  },
  testimonials: {
